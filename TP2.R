...
res.pca
?plot
#choix pour restreindre à un seule shéma de pca , invisible pour cacher 
...
#8
res.pca$ind
#9 les contibutions ne seront pas affiché (contibution=variable qui sont affecté au pca)
res.pca$ind.sup
#10
